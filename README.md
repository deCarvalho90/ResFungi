...
Before running ResFungi analysis, you need to generate the gene/protein models from the metagenomic data.
After that step, you should have a FASTA file with your predicted proteome, which can be used to run ResFungi.

Below is the summarized pipeline we used to search for antifungal resistance genes (AFRs):
